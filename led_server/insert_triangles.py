...
def main():
    ...
    data = [
        ...
        TriangleData(0, 1, "static", (255,0,255), 1, 0, 0, 0, [_ for _ in range(12,18)]),
        TriangleData(1, 2, "static", (0,255,0), 1, 0, 0, 0, [_ for _ in range(12,18)]),
        TriangleData(0, 2, "static", (255,255,0), 1, 0, 0, 0, [_ for _ in range(12,18)]),
        # TriangleData(-1, 0, "static", (255,0,255), 1, 0, 0, 0, [_ for _ in range(6,12)]),
        TriangleData(2, 0, "static", (255,0,0), 1, 0, 0, 0, [_ for _ in range(0,6)]),
        TriangleData(3, 0, "static", (255,0,255), 1, 0, 0, 0, [_ for _ in range(6,12)]),
        TriangleData(3, 1, "static", (255,0,0), 1, 0, 0, 0, [_ for _ in range(12,18)]),
        TriangleData(2, 1, "static", (255,0,255), 1, 0, 0, 0, [_ for _ in range(12,18)]),
